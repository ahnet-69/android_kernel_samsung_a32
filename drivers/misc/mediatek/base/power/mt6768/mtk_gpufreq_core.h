...
#define SEG_GPU_DVFS_VOLT32		(61850)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT33             (61820)         /* mV x 100 */
#define SEG_GPU_DVFS_VOLT34             (61800)         /* mV x 100 */
#define SEG_GPU_DVFS_VOLT35             (61750)         /* mV x 100 */
#define SEG_GPU_DVFS_VOLT36             (61720)         /* mV x 100 */
#define SEG_GPU_DVFS_VOLT37             (61700)         /* mV x 100 */
#define SEG_GPU_DVFS_VOLT38             (61650)         /* mV x 100 */
#define SEG_GPU_DVFS_VOLT39             (61620)         /* mV x 100 */

#define SEG_GPU_DVFS_VSRAM0		(97500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(95000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(93000)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(89375)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM4		(87150)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM5		(87125)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM6		(86875)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM7		(86825)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM8		(85250)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM9		(84750)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM10		(83750)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM11		(83250)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM12		(83150)		/* mV x 100 */
